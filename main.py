...
def attack(char_name: str, char_class: str) -> str:
    ...
    в зависимости от выбрвнного типа персонажа
    и возвращает строковое сообщение о проведенной атаке.
    """
...
def special(char_name: str, char_class: str) -> str:
    """В зависимости от выбраного типа персонажа
    возвращает сообщение о применении
    специального умения.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    введенное игроком имя персонажа
